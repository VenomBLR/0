...
class controllerReimbursement{
    ...
    static submitReimbursement = async (req: Request, res: Response) => {
       ...
       await Pool.query(`select SubmitReim($1, $2, $3, $4, $5, $6, $7)`, [newReimbursement.author, newReimbursement.amount, newReimbursement.datesubmitted, newReimbursement.description, newReimbursement.resolver, newReimbursement.statusid, newReimbursement.typeid]);  
